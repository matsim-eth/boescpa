...
import ch.ethz.matsim.boescpa.analysis.trips.Trip;
import ch.ethz.matsim.boescpa.analysis.trips.TripEventHandler;
...
/**
 * Decorates ch.ethz.matsim.boescpa.analysis.trips.TripHandler with the method createResults(..).
 *
 ...
 * @author boescpa
 */
public class TripActivityCrosscorrelator extends ScenarioAnalyzerEventHandlerHomeInSHP implements PersonDepartureEventHandler, PersonArrivalEventHandler,
	...
	public TripActivityCrosscorrelator(String pathToHomesSHP, Population population, Network network) {
		super(pathToHomesSHP, population);
