 ...
 * @author boescpa
 */
public class AgentCounter extends ScenarioAnalyzerEventHandlerHomeInSHP implements ActivityEndEventHandler {

	private final List<String[]> agentsAndLinks = new ArrayList<>();
	private final Network network;

	public AgentCounter(String pathToHomesSHP, Population population, Network network) {
