 ...
 * @author boescpa
 */
public class TripAnalyzer extends ScenarioAnalyzerEventHandlerHomeInSHP implements PersonDepartureEventHandler, PersonArrivalEventHandler,
	...
	public TripAnalyzer(String pathToHomesSHP, Population population, Network network) {
